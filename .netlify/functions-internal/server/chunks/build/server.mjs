...
import { inject, shallowRef, computed, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, effectScope, isRef, defineComponent, h, Fragment, createElementBlock, provide, cloneVNode, defineAsyncComponent, unref, shallowReactive, ref, Suspense, createApp, createVNode, Text, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, isReadonly, isShallow, isReactive, toRaw, toValue, watch, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { r as createError$1, z as klona, A as defuFn, B as hasProtocol, C as isScriptProtocol, D as joinURL, E as withQuery, F as sanitizeStatusCode, G as getContext, H as parsePath, I as parseQuery, $ as $fetch$1, J as baseURL, K as createHooks, L as executeAsync, M as parseURL, N as toRouteMatcher, O as createRouter$1, P as defu, Q as getRequestURL, R as getCookie, S as getRequestHeader, T as createDefu, t as destr, U as parse$1, V as isEqual, W as withoutTrailingSlash, X as setCookie, Y as deleteCookie, Z as isEqual$1 } from '../_/nitro.mjs';
...
const component_45stubMoThHxowMYf657KTmIF_EBbfY_j1MmN0oW9p84cY6F8 = {};
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-D20VKtxp.mjs')
  },
  {
    name: "about___fr",
    path: "/fr/about",
    component: () => import('./about-BhMDuR0_.mjs')
  },
  {
    name: "about___en",
    path: "/en/about",
  ...
  },
  {
    name: "hacks___fr",
    path: "/fr/hacks",
    component: () => import('./hacks-D25zEKVm.mjs')
  },
  {
    name: "hacks___en",
    path: "/en/hacks",
  ...
  },
  {
    name: "contact___fr",
    path: "/fr/contact",
    component: () => import('./contact-DdFmdvf1.mjs')
  },
  {
    name: "contact___en",
    path: "/en/contact",
  ...
  },
  {
    ...
    path: "/fr/sitemap.xml",
    component: component_45stubMoThHxowMYf657KTmIF_EBbfY_j1MmN0oW9p84cY6F8
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/en/sitemap.xml",
...
const LazyIcon = defineAsyncComponent(() => import('./index-DysfMA8s.mjs').then((r) => r["default"] || r.default || r));
  ...
  fr: [
    {
      ...
      load: () => import(
        './fr-DFrDI21v.mjs'
        /* webpackChunkName: "locale_fr_46json_60abc0b7" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-CI7koRpN.mjs'
        /* webpackChunkName: "locale_en_46json_58ca31ea" */
      ),
      cache: true
    }
  ],
  es: [
    {
      ...
      load: () => import(
        './es-CXUli66T.mjs'
        /* webpackChunkName: "locale_es_46json_90c69451" */
      ),
      cache: true
    }
  ],
  hi: [
    {
      ...
      load: () => import(
        './hi-vZ1qh9-Y.mjs'
        /* webpackChunkName: "locale_hi_46json_822104f9" */
      ),
      cache: true
    }
  ],
  ar: [
    {
      ...
      load: () => import(
        './ar-C64KULuJ.mjs'
        /* webpackChunkName: "locale_ar_46json_976468c7" */
      ),
      cache: true
    }
  ],
  az: [
    {
      ...
      load: () => import(
        './az-BuVreJX6.mjs'
        /* webpackChunkName: "locale_az_46json_c5c465c5" */
      ),
      cache: true
    }
  ],
  pt: [
    {
      ...
      load: () => import(
        './pt-BrTuGiY8.mjs'
        /* webpackChunkName: "locale_pt_46json_92f13794" */
      ),
      cache: true
    }
  ],
  ru: [
    {
      ...
      load: () => import(
        './ru-BzKEdefU.mjs'
        /* webpackChunkName: "locale_ru_46json_861b88e8" */
      ),
      cache: true
    }
  ],
  so: [
    {
      ...
      load: () => import(
        './so-8PdCtH1p.mjs'
        /* webpackChunkName: "locale_so_46json_344b8773" */
      ),
      cache: true
    }
  ],
  tr: [
    {
      ...
      load: () => import(
        './tr-Cq6JRdF-.mjs'
        /* webpackChunkName: "locale_tr_46json_0ee1ef70" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/fDt67SV4"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/fDt67SV4"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Bgw2THK4.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B2saLa1R.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DtLUQJTG.mjs'));
...
export { _export_sfc as _, useI18n as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, useAppConfig as e, useRuntimeConfig as f, useLocalePath as g, createI18n as h, useRouter as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, useHead as u };
