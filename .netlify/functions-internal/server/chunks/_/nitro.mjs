...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2a78d892-599e-430c-9534-016c070e196d",
...
const _5pJGefkurXQ5LvVmnZS0mtAGcDpQ249YcaKRrvOxY = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/WUgwpYYe") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const _lazy_WiTe7d = () => import('../routes/renderer.mjs');
...
export { appRootTag as a, appRootAttrs as b, appSpaLoaderTag as c, appSpaLoaderAttrs as d, buildAssetsURL as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, appId as k, defineRenderHandler as l, appTeleportTag as m, normalizeCookieHeader as n, appTeleportAttrs as o, publicAssetsURL as p, getQuery as q, createError$1 as r, appHead as s, destr as t, useNitroApp as u, getRouteRules as v, defineEventHandler as w, sitemapIndexXmlEventHandler as x, sitemapChildXmlEventHandler as y };
