...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "5e6a56e8-970c-4802-93ce-33d9fe44d7bd",
  ...
  "nuxt-robots": {
    ...
    "sitemap": [
      "www.ultimatepronos.com.sitemap.xml",
      "/sitemap_index.xml"
    ],
    "header": true,
...
const _1q3wIPKD8Ou8xk5_Va5aEtw46yZtkLPxjBwNaWjZdcY = defineNitroPlugin(async (nitroApp) => {
...
const _bWBLkA5pFDswaU_D7WTESTyIoD3WRLN0CcmRto5k30M = defineNitroPlugin(async (nitroApp) => {
...
const localeLoaders = {
  fr: [
    {
      key: "locale_fr_46json_60abc0b7",
      load: () => import('./fr.mjs' /* webpackChunkName: "locale_fr_46json_60abc0b7" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_58ca31ea",
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_58ca31ea" */),
      cache: true
    }
  ],
  es: [
    {
      key: "locale_es_46json_90c69451",
      load: () => import('./es.mjs' /* webpackChunkName: "locale_es_46json_90c69451" */),
      cache: true
    }
  ],
  hi: [
    {
      key: "locale_hi_46json_822104f9",
      load: () => import('./hi.mjs' /* webpackChunkName: "locale_hi_46json_822104f9" */),
      cache: true
    }
  ],
  ar: [
    {
      key: "locale_ar_46json_976468c7",
      load: () => import('./ar.mjs' /* webpackChunkName: "locale_ar_46json_976468c7" */),
      cache: true
    }
  ],
  az: [
    {
      key: "locale_az_46json_c5c465c5",
      load: () => import('./az.mjs' /* webpackChunkName: "locale_az_46json_c5c465c5" */),
      cache: true
    }
  ],
  pt: [
    {
      key: "locale_pt_46json_92f13794",
      load: () => import('./pt.mjs' /* webpackChunkName: "locale_pt_46json_92f13794" */),
      cache: true
    }
  ],
  ru: [
    {
      key: "locale_ru_46json_861b88e8",
      load: () => import('./ru.mjs' /* webpackChunkName: "locale_ru_46json_861b88e8" */),
      cache: true
    }
  ],
  so: [
    {
      key: "locale_so_46json_344b8773",
      load: () => import('./so.mjs' /* webpackChunkName: "locale_so_46json_344b8773" */),
      cache: true
    }
  ],
  tr: [
    {
      key: "locale_tr_46json_0ee1ef70",
      load: () => import('./tr.mjs' /* webpackChunkName: "locale_tr_46json_0ee1ef70" */),
      cache: true
    }
  ]
};
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"robots","content":"index, follow"},{"name":"theme-color","content":"#000000"}],"link":[{"rel":"icon","type":"image/png","href":"/logo.png","sizes":"96x96"}],"style":[],"script":[{"id":"Cookiebot","src":"https://consent.cookiebot.com/uc.js","async":true,"data-cbid":"b433eb58-7ffb-431f-84b2-e83a7e017c20"}],"noscript":[],"htmlAttrs":{"lang":"fr"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1","titleTemplate":"%s Ultimate Pronos"};
...
const _5pJGefkurXQ5LvVmnZS0mtAGcDpQ249YcaKRrvOxY = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/fDt67SV4") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _1q3wIPKD8Ou8xk5_Va5aEtw46yZtkLPxjBwNaWjZdcY,
_bWBLkA5pFDswaU_D7WTESTyIoD3WRLN0CcmRto5k30M,
_5pJGefkurXQ5LvVmnZS0mtAGcDpQ249YcaKRrvOxY
];
...
const _1qqO2x = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _ElZDZ1 = eventHandler(async (e) => {
...
const _FGsk5O = defineEventHandler(async (e) => {
...
const _x5wilZ = defineEventHandler(sitemapXmlEventHandler);

const _8TLkEK = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _HrVlqX = defineEventHandler(async (e) => {
...
const _WlZS71 = _messagesHandlerCached;

const _IONBoU = lazyEventHandler(() => {
...
const _lazy_WiTe7d = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
const _lazy_GnvuXU = () => import('../routes/sitemap_index.xml.mjs');
const _lazy_JJWMNf = () => import('../routes/__sitemap__/_sitemap_.xml.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_WiTe7d, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _1qqO2x, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _ElZDZ1, lazy: false, middleware: true, method: undefined },
  { route: '/sitemap_index.xml', handler: _lazy_GnvuXU, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/**:sitemap', handler: _lazy_JJWMNf, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _FGsk5O, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _x5wilZ, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _8TLkEK, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _HrVlqX, lazy: false, middleware: true, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _WlZS71, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _IONBoU, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WiTe7d, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, defuFn as A, hasProtocol as B, isScriptProtocol as C, joinURL as D, withQuery as E, sanitizeStatusCode as F, getContext as G, parsePath as H, parseQuery as I, baseURL as J, createHooks as K, executeAsync as L, parseURL as M, toRouteMatcher as N, createRouter$1 as O, defu as P, getRequestURL as Q, getCookie as R, getRequestHeader as S, createDefu as T, parse as U, isEqual as V, withoutTrailingSlash as W, setCookie as X, deleteCookie as Y, isEqual$1 as Z, withTrailingSlash as _, appRootTag as a, buildAssetsURL as b, appRootAttrs as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, appId as k, defineRenderHandler as l, appTeleportTag as m, normalizeCookieHeader as n, appTeleportAttrs as o, publicAssetsURL as p, getQuery as q, createError$1 as r, appHead as s, destr as t, useNitroApp as u, getRouteRules as v, defineEventHandler as w, sitemapIndexXmlEventHandler as x, sitemapChildXmlEventHandler as y, klona as z };
