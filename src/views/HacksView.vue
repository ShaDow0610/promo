...
const games = ref([
    ...
    { id: 23, name: 'Lucky Jet', platform: platforms['melbet'], image: '/games/lucky-jet.jpg', description: 'Double sortie et couverture des pics volatils.' },
    { id: 24, name: 'Jet Lucky 2', platform: platforms['betwinner'], image: '/games/jet-lucky-2.jpg', description: 'Variantes de sortie en deux temps, gestion des runs.' },
    { id: 25, name: 'Crazy Time', platform: platforms['1xbet'], image: '/games/crazy-time.jpg', description: 'Allocation intelligente sur bonus et rouleau.' },
    { id: 26, name: 'Monopoly Live', platform: platforms['1win'], image: '/games/monopoly-live.jpg', description: 'Couverture des cases clés, risques modulés.' },
    { id: 27, name: 'Dream Catcher', platform: platforms['melbet'], image: '/games/dream-catcher.jpg', description: 'Répartition de mise sur segments majoritaires.' },
    { id: 28, name: 'Coin Flip', platform: platforms['betwinner'], image: '/games/coin-flip.jpg', description: 'Gestion des flips consécutifs et stop-win clair.' },
    { id: 29, name: 'Penalty Shootout', platform: platforms['1xbet'], image: '/games/penalty.jpg', description: 'Sélection de côtés avec probas contextuelles.' },
    { id: 30, name: 'Goal Crash', platform: platforms['1win'], image: '/games/goal-crash.jpg', description: 'Objectifs courts, sortie rapide, risque maîtrisé.' },
    { id: 31, name: 'Andar Bahar', platform: platforms['melbet'], image: '/games/andar-bahar.jpg', description: 'Gestion des séquences et tailles de mise.' },
    { id: 32, name: 'Teen Patti', platform: platforms['betwinner'], image: '/games/teen-patti.jpg', description: 'Sélection de spots favorables, variance contenue.' },
    { id: 33, name: 'Lightning Roulette', platform: platforms['1xbet'], image: '/games/lightning-roulette.jpg', description: 'Ciblage des éclairs et couverture de base.' },
    { id: 34, name: 'Mega Ball', platform: platforms['1win'], image: '/games/mega-ball.jpg', description: 'Nombre de cartes optimal et gestion du budget.' },
    { id: 35, name: 'Razor Shark', platform: platforms['melbet'], image: '/games/razor-shark.jpg', description: 'Fenêtres d’opportunités et sortie disciplinée.' },
    { id: 36, name: 'Sugar Rush', platform: platforms['betwinner'], image: '/games/sugar-rush.jpg', description: 'Sessions courtes, focus sur bonus majorés.' },
    { id: 37, name: 'Fruit Party', platform: platforms['1xbet'], image: '/games/fruit-party.jpg', description: 'Ciblage de volatilité moyenne, bankroll stable.' },
    { id: 38, name: 'Book of Dead', platform: platforms['1win'], image: '/games/book-of-dead.jpg', description: 'Cycles de spins et limites strictes de pertes.' },
    { id: 39, name: 'The Dog House', platform: platforms['melbet'], image: '/games/dog-house.jpg', description: 'Entrées prudentes, prise de bénéfices graduelle.' },
    { id: 40, name: 'Gates of Olympus', platform: platforms['betwinner'], image: '/games/gates-of-olympus.jpg', description: 'Exposition maîtrisée sur multiplicateurs élevés.' },
])
