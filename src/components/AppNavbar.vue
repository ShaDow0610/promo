            ...
            <div class="mt-3 mb-2 bg-black/40 backdrop-blur border border-white/10 rounded-xl px-3 sm:px-2 py-1.5">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center gap-1.5">
                        ...
                        <RouterLink to="/contact" class="nav-link"
                            active-class="!text-white !bg-white/10 !border-white/10">Contact</RouterLink>
                    </div>
                ...
                <transition name="fadeFast">
                    <div v-if="navOpen" class="md:hidden mt-2 grid grid-cols-2 gap-2">
                        <RouterLink to="/hacks" class="nav-pill" @click="navOpen = false">Nos hacks</RouterLink>
                        <RouterLink to="/gains" class="nav-pill" @click="navOpen = false">Plus grands gains</RouterLink>
                        <RouterLink to="/about" class="nav-pill" @click="navOpen = false">À propos</RouterLink>
                        <RouterLink to="/contact" class="nav-pill" @click="navOpen = false">Contact</RouterLink>
                    </div>
                </transition>
            </div>
        </div>
