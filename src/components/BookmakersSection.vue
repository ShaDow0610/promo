<script setup>
    ...
    const bookmakers = [
        {name:"Melbet" , logo:"/", code:"Viva2025", note: "Bonus jusqu'a 200%"} ,
        {name:"1xbet" , logo:"/", code:"Viva2025",  note: "100% sur ton premier depot"} ,
        {name:"1win" , logo:"/", code:"Viva2025",  note: "jusqu'a 500$ de bonus"} ,
    ...
    onMounted(async ()=>{
        ...
        if(!isTouch && logoCards.value.length > 0){
            ...
            logoCards.value.forEach(el=>{
                const onDown = () =>el.classList.add("scale-95")
                const onUp =() =>el.classList.remove("scale-95")
...
<template>
    <section ref="sectionEl" class="relative w-full py-20 bg-gradient-to-br from-black via-gray-900 to-black text-white">
        <div class="max-w-6xl mx-auto px-6">
            <!-- titre & pitch -->
             <div class="text-center mb-12">
                ...
                <p class="bmk-head text-gray-300 max-w-2xl mx-auto">
                    ...
                    <span class="text-yellow-400">gains</span> mieux valorises. le spectacle commence ici.
                </p>
             </div>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 mb-14">
                ...
                >
                    <img :src="book.logo " :alt="book.name" class="h-14 md:h-16 mb-4 object-contain opacity-95 " loading="lazy"/>
            ...
            <!-- les 3 raison : bonnu / fiabilite/ gains -->
             ...
             <div class="flex flex-col items-center gap-4">
                <a href="#" target="_blank"
                    class="inline-flex items-center gap-2 px-3 py-3 rounded-full font-bold by-yellow-400 text-black shadow-xl hover:scale-105 transition"
                >
